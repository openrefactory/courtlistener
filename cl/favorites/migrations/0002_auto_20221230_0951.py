# Generated by Django 3.2.16 on 2022-12-30 17:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='usertagevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='history', to='favorites.usertag'),
        ),
        migrations.AddField(
            model_name='usertagevent',
            name='user',
        ...
        migrations.AddField(
            model_name='prayerevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='history', to='favorites.prayer'),
        ),
        migrations.AddField(
            model_name='prayerevent',
            name='recap_document',
        ...
        migrations.AddField(
            model_name='favoriteevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='history', to='favorites.favorite'),
        ),
        migrations.AddField(
            model_name='favoriteevent',
            name='recap_doc_id',
        ...
        migrations.AddField(
            model_name='dockettagevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='history', to='favorites.dockettag'),
        ),
        migrations.AddField(
            model_name='dockettagevent',
            name='tag',
